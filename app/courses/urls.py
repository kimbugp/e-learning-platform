...
urlpatterns = [
    ...
    path("", courses_views.CoursesListView.as_view(), name="courses_list"),
    path(
        "<pk>/edit/",
    ...
    path(
        "<int:pk>/module/<int:module_id>/",
        modules_view.ModuleContentListView.as_view(),
        name="module_content_list",
    ),
    # content
    path(
        "module/<int:module_id>/content/<model_name>/",
    ...
    path(
        "module/<int:module_id>/content_view/<id>/",
